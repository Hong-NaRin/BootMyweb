...
//    }
    ...
    // 1. criteria같은 객체에 검색 키워드를 추가
    // 2. 목록sql, 전체 게시글sql 둘 다 동적 쿼리로 변경
    // 3. 화면에서 사용자가 검색버튼을 누를 때, 다시 page번호를 1번으로, amount를 유지
    ...
    public String productUpdate(ProductVO vo,
        ...
        // @RequestParam("prodId") int prodId로 받기 때문에 키=값을 적어줘야 함
